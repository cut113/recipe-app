...
export const recipeList = [
  ...
  },
  {
    id: "09",
    name: "Bun Bo Hue",
    image: require("../assets/images/bun-bo.jpg"),
    rating: "5.0",
    ingredients: ["Rice Noodles", "Beef broth", "Raw Beef", "Vegetables"],
    time: "35 mins",
    difficulty: "Normal",
    calories: "300 cal",
    color: "#f96163",
    description: "A traditional Vietnamese dish that.",
    steps: [
      "Boil the ramen noodles according to package instructions.",
      "In a pot, bring water to a simmer and add soy sauce for the broth.",
      "Add chopped vegetables and let them cook until tender.",
  ...
  },
  {
    id: "10",
    name: "Pho",
    image: require("../assets/images/pho-org.png"),
    rating: "4.8",
    ingredients: [
      "Rice noodles","Beef broth",
      "Beef brisket",
      "Beef chuck",
      "Ginger",
      "Onions",
    ...
    color: "#f9d461",
    description:
      "A comforting Vietnamese noodle soup with a rich and flavorful beef broth, tender beef brisket, and rice noodles, garnished with fresh herbs.",
    steps: [
      "Char the ginger and onions over a high heat until blackened.",
      "Place the charred ginger and onions, along with the star anise, cloves, and cinnamon in a spice bag.",
      "Combine the beef broth, spice bag, fish sauce, salt, and sugar in a large pot and bring to a boil.",
      "Reduce heat to low and simmer for at least 2 hours, or up to overnight, for a more flavorful broth.",
      "While the broth is simmering, cook the rice noodles according to package instructions.",
      "Thinly slice the beef brisket and chuck.",
      "To assemble, place a handful of cooked rice noodles in a bowl and top with the sliced beef brisket and chuck.",
      "Ladle the hot broth over the top and garnish with fresh mint and basil.",
    ],
  },
  {
	"id": "11",
	"name": "Banh Mi",
	"image": require("../assets/images/banh-mi.jpg"),
	"rating": "4.7",
	"ingredients": ["Baguette", "Pate", "Mayonnaise", "Pickled carrots and daikon", "Cucumber", "Cilantro", "Jalapeños", "Sriracha sauce", "Salt", "Pepper"],
	"time": "15 mins",
	"difficulty": "Easy",
	"calories": "300 cal",
	"color": "#f9c461",
	"description": "A Vietnamese sandwich made with a crusty baguette filled with pâté, mayonnaise, pickled vegetables, cilantro, jalapeños, and sriracha sauce.",
	"steps": [
	  "Slice the baguette in half lengthwise.",
	  "Spread a thin layer of pâté on each half of the baguette.",
	  "Top with pickled carrots and daikon, cucumber, cilantro, jalapeños, and sriracha sauce to taste.",
